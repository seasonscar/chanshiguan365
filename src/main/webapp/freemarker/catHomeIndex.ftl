...
<div class="titlebar">
	彼<br/>女<br/>の<br/>猫<br/>
    <div class="line top" style="background: linear-gradient(#d481ff, #05f1e1);"></div>
    <div class="line bottom" style="background: linear-gradient(#05f1e1, #d481ff);"></div>
        ...
        <#list 1..8 as t>
            <div class="col-md-3 col-sm-6" style="margin-bottom: 30px;">
                <div class="product-grid">
                    <a href="#popup-article" class="product-image">
                        <div class="pic-1">
                            <img src="static/img/demo${t}.jpg"/>
                        </div>
                        <div class="pic-2">
                            <div class="pic">
                                <img src="static/img/demo${t}.jpg">
                            ...
                            <div class="team-content">
                                <h3 class="title">六六</h3>
                                <span class="post">喵喵守护者</span>
                            </div>
                        </div>
                    </a>
                </div>
...
<div id="popup-article" class="popup">
  <div class="popup__block">
    ...
    <img src="static/img/nature.jpg" class="popup__media popup__media_right" alt="The foto of nature">
